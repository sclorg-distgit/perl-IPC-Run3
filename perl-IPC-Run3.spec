...
# Run optional tests
%if ! (0%{?scl:1})
%bcond_without perl_IPC_Run3_enables_optional_test
%else
%bcond_with perl_IPC_Run3_enables_optional_test
%endif
...
%if %{with perl_IPC_Run3_enables_optional_test}
# For improved tests
...
%check
%{?scl:scl enable %{scl} '}make test %{!?scl:RELEASE_TESTING=1}%{?scl:'}
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.048-18
- SCL
